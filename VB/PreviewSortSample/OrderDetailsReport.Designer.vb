...
'#End Region
        ...
        Private nwindDataSet1 As PreviewSortSample.nwindDataSet

        Private orderDetailsTableAdapter As PreviewSortSample.nwindDataSetTableAdapters.OrderDetailsTableAdapter
